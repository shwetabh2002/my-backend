  ...
  try {
    ...
    const sampleInventory = [
      ...
      // Car Parts
      {
        ...
        model: 'Camry',
        year: 2023,
        sku: 'PART-TOYOTA-OILFILTER-2023-001',
        ...
        compatibility: [
          {
            ...
            yearFrom: 2020,
            yearTo: 2025,
            notes: 'Compatible with all Camry models 2020-2025'
          },
          {
            brand: 'Toyota',
            model: 'Corolla',
            yearFrom: 2020,
            yearTo: 2024,
            notes: 'Also compatible with Corolla models'
          }
        ],
        dimensions: {
          length: 3.5,
        ...
        compatibility: [
          {
            ...
            yearFrom: 2020,
            yearTo: 2025,
            notes: 'Fits Toyota Camry 2020-2025'
          },
          {
            brand: 'Honda',
            model: 'Civic',
            yearFrom: 2020,
            yearTo: 2024,
            notes: 'Fits Honda Civic 2020-2024'
          }
        ],
        dimensions: {
          length: 6.0,
        ...
        compatibility: [
          {
            ...
            yearFrom: 2020,
            yearTo: 2025,
            notes: 'Universal fit for most sedans'
          },
          {
            brand: 'Honda',
            model: 'Civic',
        ...
        compatibility: [
          {
            ...
            yearFrom: 2020,
            yearTo: 2025,
            notes: 'Iridium spark plugs for Toyota engines'
          },
          {
            brand: 'Honda',
            model: 'Civic',
            yearFrom: 2020,
            yearTo: 2024,
            notes: 'Iridium spark plugs for Honda engines'
          }
        ],
        dimensions: {
          length: 2.5,
      ...
      },
      {
        ...
        brand: 'Bosch',
        model: 'Universal',
        sku: 'PART-BOSCH-WIPERBLADES-001',
